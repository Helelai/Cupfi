...
exports.Avatar = React.forwardRef((props, ref) => {
    const { size = constants_1.DEFAULT_AVATAR_SIZE, theme = 'normal', view = 'filled', backgroundColor, borderColor, title, className, style: styleProp, qa, } = props;
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: (0, constants_1.bAvatar)({ size, theme, view, 'with-border': Boolean(borderColor) }, className), title: title, role: "img", style: style, "data-qa": qa, ref: ref, ...(0, filterDOMProps_1.filterDOMProps)(props, { labelable: true }), children: renderContent() }));
});
