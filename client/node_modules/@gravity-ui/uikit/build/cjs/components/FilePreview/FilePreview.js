...
function FilePreview({ className, qa, file, imageSrc, description, onClick, actions, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: cn({ mobile }, className), "data-qa": qa, children: [(0, jsx_runtime_1.jsxs)("div", { className: cn('card', { clickable, hoverable: clickable || withActions }), role: clickable ? 'button' : undefined, onKeyDown: clickable ? onKeyDown : undefined, tabIndex: clickable ? 0 : undefined, onClick: onClick, children: [isPreviewString ? ((0, jsx_runtime_1.jsx)("div", { className: cn('image-container'), children: (0, jsx_runtime_1.jsx)("img", { className: cn('image'), src: previewSrc, alt: file.name }) })) : ((0, jsx_runtime_1.jsx)("div", { className: cn('icon-container'), children: (0, jsx_runtime_1.jsx)("div", { className: cn('icon', { type }), children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { className: cn('icon-svg'), data: FILE_ICON[type], size: 20 }) }) })), (0, jsx_runtime_1.jsx)(Text_1.Text, { className: cn('name'), color: "secondary", ellipsis: true, title: file.name, children: file.name }), Boolean(description) && ((0, jsx_runtime_1.jsx)(Text_1.Text, { className: cn('description'), color: "secondary", ellipsis: true, title: description, children: description }))] }), (0, jsx_runtime_1.jsx)(FilePreviewActions_1.FilePreviewActions, { actions: actions, hoverabelPanelClassName: cn('actions-panel'), fileName: file.name, isCustomImage: isPreviewString })] }));
}
