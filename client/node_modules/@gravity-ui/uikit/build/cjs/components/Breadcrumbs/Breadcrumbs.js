...
exports.Breadcrumbs = React.forwardRef(function Breadcrumbs(props, ref) {
    ...
    const breadcrumbsItems = contents.map((child, index) => {
        ...
        return ((0, jsx_runtime_1.jsxs)("li", { className: (0, utils_1.b)('item', { calculating: !calculated }), children: [item, isCurrent ? null : (0, jsx_runtime_1.jsx)(BreadcrumbsSeparator_1.BreadcrumbsSeparator, { separator: props.separator })] }, index));
    });
