...
function Popover({ children, open, onOpenChange, disabled, content, trigger, modal = true, openDelay = DEFAULT_OPEN_DELAY, closeDelay = DEFAULT_CLOSE_DELAY, enableSafePolygon, className, ...restProps }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(React.Fragment, { children: [anchorNode, (0, jsx_runtime_1.jsx)(Popup_1.Popup, { ...restProps, open: context.open, floatingContext: context, floatingRef: setFloatingElement, floatingInteractions: interactions, modal: modal, className: b(null, className), children: content })] }));
}
