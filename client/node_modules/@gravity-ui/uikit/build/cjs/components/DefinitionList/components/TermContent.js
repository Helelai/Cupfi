...
function NoteElement({ note }) {
    ...
    if (typeof note === 'string') {
        return ((0, jsx_runtime_1.jsx)(HelpMark_1.HelpMark, { popoverProps: { placement: ['bottom', 'top'] }, "aria-label": (0, i18n_1.default)('label_note'), children: note }));
    }
    if (typeof note === 'object') {
        return ((0, jsx_runtime_1.jsx)(HelpMark_1.HelpMark, { ...note, popoverProps: { placement: ['bottom', 'top'], ...note.popoverProps }, "aria-label": (0, i18n_1.default)('label_note') }));
    }
    return null;
}
