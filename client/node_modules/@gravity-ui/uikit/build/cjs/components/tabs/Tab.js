...
require("./Tab.css");
exports.Tab = React.forwardRef((props, ref) => {
    ...
    if (props.href) {
        return ((0, jsx_runtime_1.jsx)("a", { ...tabProps, href: props.href, ref: ref, children: content }));
    }
    return ((0, jsx_runtime_1.jsx)("button", { ...tabProps, type: "button", ref: ref, children: content }));
});
