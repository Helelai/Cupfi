...
function useTab(tabProps) {
    ...
    const onKeyDown = (event) => {
        if ((event.key === constants_1.KeyCode.SPACEBAR || event.key === constants_1.KeyCode.ENTER) && !tabProps.disabled) {
            tabContext.onUpdate?.(tabProps.value);
        }
    };
    return {
        ...
        ...(0, filterDOMProps_1.filterDOMProps)(tabProps, { labelable: true }),
    };
}
