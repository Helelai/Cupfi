...
function prepareChildren(children) {
    ...
    if (!summary) {
        summary = ((0, jsx_runtime_1.jsx)(DisclosureSummary_1.DisclosureSummary, { children: (props) => (0, jsx_runtime_1.jsx)(DisclosureSummary_1.DefaultDisclosureSummary, { ...props }) }));
    }
