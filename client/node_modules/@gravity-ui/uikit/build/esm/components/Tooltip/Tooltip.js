...
export function Tooltip({ children, open, onOpenChange, strategy, placement: placementProp = DEFAULT_PLACEMENT, offset: offsetProp = DEFAULT_OFFSET, disabled, content, trigger, role: roleProp = 'tooltip', openDelay = DEFAULT_OPEN_DELAY, closeDelay = DEFAULT_CLOSE_DELAY, className, style, qa, ...restProps }) {
    ...
    return (_jsxs(React.Fragment, { children: [anchorNode, isOpen && !disabled ? (_jsx(Portal, { children: _jsx("div", { ref: refs.setFloating, style: {
                        position: 'absolute',
                        top: 0,
                        left: 0,
                        zIndex: 10000,
