...
export function ListItemViewComponent(props, ref) {
    ...
    return (_jsx(Component, { ref: componentRef, ...restProps, ...filterDOMProps(props), className: b({
            size,
        ...
        }, children: isContainer ? (_jsx(Slot, { name: "container", children: children })) : (_jsx(ListItemViewContent, { ...props, children: children })) }));
}
