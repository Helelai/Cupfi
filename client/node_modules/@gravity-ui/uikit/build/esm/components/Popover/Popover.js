...
export function Popover({ children, open, onOpenChange, disabled, content, trigger, modal = true, openDelay = DEFAULT_OPEN_DELAY, closeDelay = DEFAULT_CLOSE_DELAY, enableSafePolygon, className, ...restProps }) {
    ...
    return (_jsxs(React.Fragment, { children: [anchorNode, _jsx(Popup, { ...restProps, open: context.open, floatingContext: context, floatingRef: setFloatingElement, floatingInteractions: interactions, modal: modal, className: b(null, className), children: content })] }));
}
