...
export declare function Popup({ keepMounted, hasArrow, open, onOpenChange, strategy, placement: placementProp, offset: offsetProp, anchorElement, anchorRef, floatingMiddlewares, floatingContext, floatingInteractions, floatingRef, floatingStyles: floatingStylesProp, floatingClassName, modal, initialFocus: initialFocusProp, returnFocus, focusOrder, disableVisuallyHiddenDismiss, onClose, onEscapeKeyDown, onOutsideClick, disableEscapeKeyDown, disableOutsideClick, disableFocusOut, style, className, children, disablePortal, disableLayer, disableTransition, qa, role: roleProp, zIndex, onTransitionIn, onTransitionOut, onTransitionInComplete, onTransitionOutComplete, ...restProps }: PopupProps): import("react/jsx-runtime").JSX.Element | null;
