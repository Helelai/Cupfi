...
export const Avatar = React.forwardRef((props, ref) => {
    const { size = DEFAULT_AVATAR_SIZE, theme = 'normal', view = 'filled', backgroundColor, borderColor, title, className, style: styleProp, qa, } = props;
    ...
    return (_jsx("div", { className: bAvatar({ size, theme, view, 'with-border': Boolean(borderColor) }, className), title: title, role: "img", style: style, "data-qa": qa, ref: ref, ...filterDOMProps(props, { labelable: true }), children: renderContent() }));
});
