...
function NoteElement({ note }) {
    ...
    if (typeof note === 'string') {
        return (_jsx(HelpMark, { popoverProps: { placement: ['bottom', 'top'] }, "aria-label": i18n('label_note'), children: note }));
    }
    if (typeof note === 'object') {
        return (_jsx(HelpMark, { ...note, popoverProps: { placement: ['bottom', 'top'], ...note.popoverProps }, "aria-label": i18n('label_note') }));
    }
    return null;
}
