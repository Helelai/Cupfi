...
export function DefinitionListItem({ name, children, copyText, note }) {
    ...
    return (_jsxs("div", { className: b('item'), children: [_jsx("dt", { className: b('term-container'), style: keyStyle, children: _jsx(TermContent, { direction: direction, name: name, note: note }) }), _jsx("dd", { className: b('definition'), style: {
                    ...valueStyle,
