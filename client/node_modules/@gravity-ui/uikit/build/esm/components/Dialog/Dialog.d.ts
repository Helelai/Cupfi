...
export declare function Dialog({ container, children, open, disableBodyScrollLock, disableEscapeKeyDown, disableOutsideClick, initialFocus, returnFocus, keepMounted, size, contentOverflow, className, modalClassName, hasCloseButton, onEscapeKeyDown, onEnterKeyDown, onOpenChange, onOutsideClick, onClose, onTransitionIn, onTransitionInComplete, onTransitionOut, onTransitionOutComplete, qa, ...restProps }: DialogProps): import("react/jsx-runtime").JSX.Element;
