...
export function BreadcrumbsDropdownMenu({ children, disabled, popupPlacement, popupStyle, }) {
    ...
    return (_jsxs("div", { className: b('menu'), children: [_jsx(Button, { ref: setReference, ...getReferenceProps(), title: i18n('label_more'), "aria-label": i18n('label_more'), className: b('more-button'), size: "s", view: "flat", disabled: disabled, children: _jsx(Button.Icon, { children: "..." }) }), _jsx(Popup, { floatingContext: context, floatingRef: setFloating, floatingInteractions: interactions, placement: popupPlacement, className: b('menu-popup'), children: _jsx(menuContext.Provider, { value: { isMenu: true, getItemProps, listItemsRef, activeIndex, popupStyle }, children: children }) })] }));
}
