...
import "./Button.css";
function isButtonComoponentProps(p) {
    return p.component !== undefined;
}
const b = block('button');
const _Button = React.forwardRef(function Button(props, ref) {
    const { view = 'normal', size = 'm', pin = 'round-round', selected, disabled = false, loading = false, width, children, extraProps, qa, ...rest } = props;
